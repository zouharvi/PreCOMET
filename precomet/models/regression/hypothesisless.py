...
========================
    Hypothesisless Regression Metric that learns to predict a quality assessment by
...
from precomet.models.regression.regression_metric import RegressionMetric
from precomet.models.utils import Prediction, Target
from precomet.modules import FeedForward


class HypothesislessRegression(RegressionMetric):
    """HypothesislessRegression:
    ...
    def forward(
        ...
        **kwargs
        ...
        """HypothesislessRegression model forward method.
